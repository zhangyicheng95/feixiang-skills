...
```html
<script src="https://www.feixianglaoshi.com/musk-collect/musk-collect.js?v=1.4.0"></script>
```
...
7. **答题/测验类收集页默认不即时批改**：单题作答后只记录选择，不显示正确/错误、正确答案、解析或实时得分；最终提交后再展示分数/结果。除非用户明确要求即时反馈
